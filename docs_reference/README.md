...
1. [Спецификация (API) - 1 шт.](docs_reference/screens.md)
1. [Файлы yaml для импорта товаров - 1 шт.](./data/shop1.yaml)
1. [Базовый пример API Сервиса для магазина](docs_reference//netology_pd_diplom/) 
...
**Базовая часть:**
1. [Создание и настройка проекта.](docs_reference/step-1.md)
2. [Проработка моделей данных.](docs_reference/step-2.md)
3. [Реализация импорта товаров.](docs_reference/step-3.md)
4. [Реализация API views.](docs_reference/step-4.md)
5. [Полностью готовый backend.](docs_reference/step-5.md)

**Продвинутая часть** (выполняется по желанию, если базовая часть полностью готова):

6. [Реализация forms и views админки склада.](docs_reference/step-6-adv.md)
7. [Вынос медленных методов в задачи Celery.](docs_reference/step-7-adv.md)
...
[перейдите по ссылке](docs_reference/step-1.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-2.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-3.md).

### Этап 4. Реализация APIViews

**Критерии достижения**

1. Реализованы API Views для основных [страниц](docs_reference/screens.md) сервиса (без админки):
   - Авторизация
   - Регистрация
...
Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-4.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-5.md).

## Полезные материалы

1. [Информация о сервисе](docs_reference/service.md)
2. [Спецификация API](docs_reference/api.md)
3. [Описание страниц сервиса](docs_reference/screens.md)
...
1. Реализованы API views для [страниц админки](docs_reference/screens.md) сервиса.

Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-6-adv.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](docs_reference/step-7-adv.md).  
